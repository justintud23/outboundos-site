...
import { groupTimelineItems } from '../utils/group-timeline-items'
  ...
  return (
    <div className="relative">
      ...
      {groups.map((group, groupIdx) => (
        <div key={group.label}>
          {/* Group heading */}
          <div className={`relative flex items-center gap-3 ${groupIdx > 0 ? 'mt-5' : ''} mb-2`}>
            <div className="relative z-10 w-[35px] flex justify-center flex-shrink-0">
              <div className="h-px w-3 bg-[var(--border-default)]" />
            </div>
            ...
            {group.items.map((item, index) => {
              ...
              return (
                <div
                  ...
                  style={{ animationDelay: `${(groupIdx * 5 + index) * 30}ms` }}
                >
                  {/* Icon dot */}
                  <div
