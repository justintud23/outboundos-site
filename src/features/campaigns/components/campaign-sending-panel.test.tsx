...
describe('CampaignSendingPanel', () => {
  it('explains the sample gate and approves the sample', async () => {
    ...
    render(<CampaignSendingPanel campaignId="c1" autoSend sampleSize={10} sampleApprovedAt={null} sampleCount={8} msConnected />)
  ...
  it('shows live status once the sample is approved', () => {
    render(<CampaignSendingPanel campaignId="c1" autoSend sampleSize={10} sampleApprovedAt={new Date('2026-09-20')} sampleCount={10} msConnected />)
  ...
  it('toggles auto-send via PATCH', async () => {
    ...
    render(<CampaignSendingPanel campaignId="c1" autoSend={false} sampleSize={10} sampleApprovedAt={null} sampleCount={0} msConnected />)
  ...
  it('explains that queued emails are held while auto-send is off (I6)', () => {
    render(<CampaignSendingPanel campaignId="c1" autoSend={false} sampleSize={10} sampleApprovedAt={new Date('2026-09-20')} sampleCount={10} msConnected />)
  ...
  it('disables the auto-send toggle with a hint until Microsoft 365 is connected (M8)', () => {
    render(<CampaignSendingPanel campaignId="c1" autoSend={false} sampleSize={10} sampleApprovedAt={null} sampleCount={0} msConnected={false} />)
  ...
  it('still lets auto-send be turned OFF without Microsoft 365', () => {
    render(<CampaignSendingPanel campaignId="c1" autoSend sampleSize={10} sampleApprovedAt={new Date('2026-09-20')} sampleCount={10} msConnected={false} />)
